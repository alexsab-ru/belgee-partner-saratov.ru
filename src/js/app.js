...
cookiecook();
connectForms('https://alexsab.ru/lead/belgee/partner-saratov/', {
...
grecaptcha.ready(function() {
	grecaptcha.execute('6Lepfy4pAAAAAAGHFP655qNe6Bb_BcskklcxajC6', {action: 'belgee_partner_saratov'}).then(function(token) {
